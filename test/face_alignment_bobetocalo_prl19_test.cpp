/** ****************************************************************************
 *  @file    face_alignment_bobetocalo_prl19_test.cpp
  ...
  )
{
  ...
  upm::DB_PARTS[upm::FacePartLabel::bmouth] = {156, 157, 23, 159, 160, 166, 167, 168};
...
//  showResults(viewer, ticks, 0, frame, composite, faces, ann);
  ...
  UPM_PRINT("End of face_alignment_bobetocalo_prl19_test");
  return EXIT_SUCCESS;
};
